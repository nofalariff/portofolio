  ...
  return (
    <>
      ...
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-3s">
          <div className="flex items-center gap-3 mb-6 bg-zinc-800 w-fit p-4 rounded-2xl">
            ...
            <img src={DataImage.HiringImage} alt="Hero Image" className="w-10 rounded-md" loading="lazy" />
            <q>Available for hire ✍️</q>
          </div>
          <h1 className="text-5xl/tight font-bold mb-6">Hii, Saya Nova Izanah</h1>

          {/* Deskripsi Diri */}
          <p className="text-base/tight mb-6 opacity-50">
          ...
          <div className="flex items-center sm:gap-4 gap-2">
            <a href="https://drive.google.com/file/d/1wwQURSbKumVnS7r-pwWa_7_3ypQfSPGN/view?usp=drive_link" className="bg-violet-700 p-4 rounded-2xl hover:bg-violet-500">
              Download CV <i className="ri-download-line"></i>
            </a>
            <a href="#proyek" className="bg-zinc-700 p-4 rounded-2xl hover:bg-zinc-500">
              Volunteer <i className="ri-arrow-down-line ri-lg"></i>
            </a>
          </div>
        </div>

        {/* Gambar profile */}
        <img src={DataImage.HeroImage2} alt="Hero Image" className="w-[540px] rounded-4xl md:ml-auto animate__animated animate__fadeInUp animate__delay-4s" loading="lazy" />
      </div>
      {/* Akhir Hero */}

      {/* Awal Tentang */}
      <div className="tentang mt-32 py-10" id="tentang">
        <div className="xl::w-2/3 lg:w-3/4 w-full mx-auto p-7 bg-zinc-800 rounded-lg animate__animated animate__fadeInUp animate__delay-3s" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
          <p className="text-base/loose mb-10">
            Hi, perkenalkan saya Nova Izanah, seorang Full Stack Web Developer dan Designer untuk UI/UX Design maupun Product Digital, Saya percaya bahwa desain dan fungsionalitas harus berjalan beriringan, sehingga setiap proyek yang saya
            kembangkan tidak hanya terlihat menarik tetapi juga memberikan pengalaman pengguna yang optimal.
          </p>
          <div className="flex items-center justify-between">
            <img src={DataImage.HeroImage2} alt="Tentang image" className="w-12 rounded-md sm:block hidden" loading="lazy" />
        ...
        <div className="tools mt-32">
          ...
          <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">
            Berikut ini beberapa tools yang saya gunakan untuk membuat beberapa project atau design{" "}
          </p>
          <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
            {/* Me-looping supaya singkat */}
            {listTools.map((tool) => (
      ...
      <div className="proyek mt-32 py-10" id="proyek">
        ...
        <div className="proyek-box mt-14 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
          ...
          {listProyek.map((proyek) => (
            <div key={proyek.id} className="p-4 bg-zinc-8 rounded-md" data-aos="fade-up" data-aos-duration="1000" data-aos-delay={proyek.dad} data-aos-once="true">
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
        <h1 className="text-4xl mb-2 font-bold text-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">
          Kontak
        </h1>
        ...
        <form
          action="https://formsubmit.co/noval.arif@raharja.info"
          method="POST"
